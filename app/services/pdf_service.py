...
class PDFGenerator:
    ...
    def _create_header_footer(self, canvas_obj, doc, title="", is_terms=False):
        ...
        # STAMP on ALL pages EXCEPT LAST - bottom RIGHT corner (not footer-bound)
        # Last page will have inline stamp near signature instead
        if self.stamp_bytes and canvas_obj._pageNumber != doc.page:
            try:
