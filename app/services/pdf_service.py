...
class PDFGenerator:
    ...
    def _create_header_footer(self, canvas_obj, doc, title="", is_terms=False, total_pages=999):
        ...
        # STAMP on pages 1 and 2 (not last page) - bottom RIGHT corner
        # First page has footer stamp, last page has inline stamp with commandant
        current_page = canvas_obj._pageNumber
        # Only show footer stamp on page 1 and 2, not last page
