...
class PDFGenerator:
    ...
    def _create_header_footer(self, canvas_obj, doc, title="", is_terms=False):
        ...
        # STAMP on ALL pages EXCEPT LAST - footer position (non-conflicting)
        # Last page will have inline stamp near signature
        if self.stamp_bytes and not canvas_obj._pageNumber == doc.page:
            try:
